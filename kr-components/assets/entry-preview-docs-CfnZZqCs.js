import {
  ...
  o as ft,
  p as ts,
} from '../assets/index-Cmc67Rxs.js';
import { g as pt, c as lt, a as rs } from '../assets/_commonjsHelpers-BosuxZz1.js';
import { d as is } from '../assets/index-DrFu-skq.js';
import { R as at, r as We } from '../assets/index-CBqU2yxZ.js';
var _i = { exports: {} },
...
const xs = 'escodegen',
  ...
  As = '2.1.0',
  ws = { node: '>=6.0' },
  ks = [{ name: 'Yusuke Suzuki', email: 'utatane.tea@gmail.com', web: 'http://github.com/Constellation' }],
...
`,
          ...
          for (
            T = !he(K(u).toString()), I = je(' ', qn(K([f, u, p]).toString())), o = 0, l = n.trailingComments.length;
            o < l;
            ++o
          )
    ...
    function Gn(n, u) {
      ...
      return (
        ...
        typeof o == 'string'
          ...
          : ((l = Dr(o.content)), (d = o.precedence != null ? o.precedence : r.Sequence), (l = le(l, d, u))),
        K(l, n)
      );
    }
    function oe() {}
...
` && (d = ['{'])),
                  ...
                  k && T === I - 1 && (n.body[T].trailingComments || Xe(n.body[T].range[1], n.range[1], d));
            }),
            d.push(pe('}')),
            d
          );
...
`
            ...
            !L && d === w - 1 && (T |= Q),
              ...
              k && d === w - 1 && (n.body[d].trailingComments || Xe(n.body[d].range[1], n.range[1], o));
          return o;
        },
        FunctionDeclaration: function (n, u) {
          return [rt(n, !0), 'function', _t(n) || fe(), n.id ? ge(n.id) : '', this.generateFunctionBody(n)];
        },
        ...
        MethodDefinition: function (n, u, o) {
          ...
          return (
            ...
            n.kind === 'get' || n.kind === 'set'
              ...
              : (d = [Vr(n), this.generatePropertyKey(n.key, n.computed), this.generateFunctionBody(n.value)]),
            U(l, d)
          );
        },
...
var sr = {
  ...
  Fs = { 5: ar, '5module': ar + ' export import', 6: ar + ' const class extends export import super' },
  Ms = /^in(stanceof)?$/,
  gr =
...
me.insertSemicolon = function () {
  if (this.canInsertSemicolon())
    return (
      this.options.onInsertedSemicolon && this.options.onInsertedSemicolon(this.lastTokEnd, this.lastTokEndLoc), !0
    );
};
...
W.parseFunction = function (e, t, r, i) {
  this.initFunction(e),
    ...
    t & ot &&
      ...
      e.id &&
        !(t & lr) &&
        this.checkLVal(e.id, this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? Sr : Ne) : Vi));
  var s = this.yieldPos,
    a = this.awaitPos,
  ...
  if (this.options.ecmaVersion >= 6)
    switch (this.type) {
      case h.bracketL:
        var e = this.startNode();
        return (
          this.next(), (e.elements = this.parseBindingList(h.bracketR, !0, !0)), this.finishNode(e, 'ArrayPattern')
        );
      case h.braceL:
...
Oe.checkLVal = function (e, t, r) {
  switch ((t === void 0 && (t = ni), e.type)) {
    case 'Identifier':
      t === Ne && e.name === 'let' && this.raiseRecoverable(e.start, 'let is disallowed as a lexically bound name'),
        this.strict &&
...
z.buildBinary = function (e, t, r, i, s, a) {
  ...
  return (
    (c.left = r), (c.operator = s), (c.right = i), this.finishNode(c, a ? 'LogicalExpression' : 'BinaryExpression')
  );
};
...
De.declareName = function (e, t, r) {
  ...
  if (t === Ne) {
    ...
    for (var f = this.scopeStack.length - 1; f >= 0; --f) {
      ...
      if ((p.var.push(e), this.inModule && p.flags & ct && delete this.undefinedExports[e], p.flags & xr)) break;
    }
...
var Wi =
  ...
  Xi = {};
function Er(e) {
  var t = (Xi[e] = { binary: Ue(Qs[e] + ' ' + si), nonBinary: { General_Category: Ue(si), Script: Ue(Ks[e]) } });
...
j.regexp_eatHexDigits = function (e) {
  var t = e.pos,
    r = 0;
  for (e.lastIntValue = 0; Ki((r = e.current())); ) (e.lastIntValue = 16 * e.lastIntValue + Zi(r)), e.advance();
  return e.pos !== t;
};
function Ki(e) {
...
$.readToken = function (e) {
  return Le(e, this.options.ecmaVersion >= 6) || e === 92 ? this.readWord() : this.getTokenFromCode(e);
};
...
$.readString = function (e) {
  for (var t = '', r = ++this.pos; ; ) {
    ...
    i === 92
      ...
      : (et(i, this.options.ecmaVersion >= 10) && this.raise(this.start, 'Unterminated string constant'), ++this.pos);
  }
...
$.readWord1 = function () {
  ...
  for (var e = '', t = !0, r = this.pos, i = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
    ...
    if (Ge(s, i)) this.pos += s <= 65535 ? 1 : 2;
      ...
      (t ? Le : Ge)(c, i) || this.invalidStringToken(a, 'Invalid Unicode escape'), (e += Cr(c)), (r = this.pos);
    } else break;
    t = !1;
  }
...
function Na(e) {
  ...
  return oi(e) === !1
    ? !1
    : ((t = e.constructor),
      t === void 0 ? !0 : ((r = t.prototype), !(oi(r) === !1 || r.hasOwnProperty('isPrototypeOf') === !1)));
}
var un = {},
  It =
    (lt && lt.__assign) ||
...
function hr(e, t) {
  return e === null || ht(e) !== 'object' || e instanceof Date || e instanceof RegExp || We.isValidElement(e)
    ? e
    : (t.add(e),
      Array.isArray(e)
        ? e.map(function (r) {
        ...
        : Object.keys(e)
            ...
            .reduce(function (r, i) {
              return (
                i === '_owner' || (i === 'current' || t.has(e[i]) ? (r[i] = '[Circular]') : (r[i] = hr(e[i], t))), r
              );
            }, {}));
}
function Ga(e) {
    ...
    var s = Ga(e),
      a = Ma(s, {
        transform: function (f, p, y) {
          var g = f[p];
          return g && We.isValidElement(g) ? Qt(Tr(g, i), !0, r, i) : typeof g == 'function' ? pn(g, i) : y;
        },
      });
    return t
...
function Xo(e) {
  ...
  return t != null && (t.params != null || t.returns != null)
    ? de({ name: 'func', short: wo(t.params, t.returns), compact: null, full: Ao(t.params, t.returns) })
...
function Qo(e, t) {
  ...
  return de({ name: 'objectOf', short: or(r), compact: i != null ? or(i) : null, full: s && or(s) });
}
function Yo(e, t) {
  ...
  ou = (e, t) => {
    ...
    if (Gr(e.render)) r = !0;
      ...
      try {
        ...
        c ? f.length === 1 && f[0].type === 'ObjectPattern' && (a = e({})) : (a = e()), a != null && wn(a) && (r = !0);
      } catch {}
    }
    let s = kn(e, t.name);
    if (s != null) {
    ...
    for (let a = 0; a < t.skip; a += 1) {
      ...
      typeof r.props.children > 'u'
        ? (At.warn('Not enough children to skip elements.'),
          typeof r.type == 'function' && r.type.name === '' && (r = at.createElement(i, { ...r.props })))
...
`
  ...
  Pu = { docs: { story: { inline: !0 }, extractArgTypes: xu, extractComponentDescription: Hn } },
  Iu = [Nn],
  Nu = [Qn];
export { Tu as applyDecorators, Nu as argTypesEnhancers, Iu as decorators, Pu as parameters };
